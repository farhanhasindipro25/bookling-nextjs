...
import MobileScreenNavDrawerPanel from "@/app/components/BaseNavbar/MobileScreenNavDrawerPanels";
import MobileScreenAuthedNavDrawerPanel from "./MobileScreenAuthedNavDrawerPanel";
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between">
          ...
          <RightSideDrawer setOpen={setIsDrawerOpen} open={isDrawerOpen}>
            <MobileScreenAuthedNavDrawerPanel setOpen={setIsDrawerOpen} />
          </RightSideDrawer>
        </div>
      </div>
    </div>
